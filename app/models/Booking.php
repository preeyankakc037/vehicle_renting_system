...
class Booking {
    ...
    public function createBooking($data) {
        ...
        $query = "INSERT INTO bookings (vehicle_id, renter_id, owner_id, pickup_date, 
                  dropoff_date, total_days, total_price) 
                  VALUES ($vehicle_id, $renter_id, $owner_id, '$pickup_date', 
                  '$dropoff_date', $total_days, $total_price)";
     ...
     */
    public function getBookingsByRenter($renter_id) {
     ...
     */
    public function getBookingsByOwner($owner_id) {
